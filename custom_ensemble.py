...
class DRLEnsembleAgent:
    ...
    def run_ensemble_strategy(
        ...
        for i in range(
            ...
            model_a2c, a2c_sharpe_list, sharpe_a2c = self._train_window(
                "a2c",
                A2C_model_kwargs,
                a2c_sharpe_list,
                validation_start_date,
            ...
            model_ppo, ppo_sharpe_list, sharpe_ppo = self._train_window(
                "ppo",
                PPO_model_kwargs,
                ppo_sharpe_list,
                validation_start_date,
            ...
            model_ddpg, ddpg_sharpe_list, sharpe_ddpg = self._train_window(
                "ddpg",
                DDPG_model_kwargs,
                ddpg_sharpe_list,
                validation_start_date,
            ...
            model_sac, sac_sharpe_list, sharpe_sac = self._train_window(
                "sac",
                SAC_model_kwargs,
                sac_sharpe_list,
                validation_start_date,
            ...
            model_td3, td3_sharpe_list, sharpe_td3 = self._train_window(
                "td3",
                TD3_model_kwargs,
                td3_sharpe_list,
                validation_start_date,
            ...
            # Check if SAC is the best model
            if (
                sharpe_sac > sharpe_a2c
                and sharpe_sac > sharpe_ppo
                and sharpe_sac > sharpe_ddpg
                and sharpe_sac > sharpe_td3
            ):
                model_use.append("SAC")
                model_ensemble = model_sac
            # Check if A2C is the best model
            elif (
                sharpe_a2c > sharpe_ppo
                and sharpe_a2c > sharpe_ddpg
                and sharpe_a2c > sharpe_td3
            ):
                model_use.append("A2C")
                model_ensemble = model_a2c
            # Check if PPO is the best model
            elif sharpe_ppo > sharpe_ddpg and sharpe_ppo > sharpe_td3:
                model_use.append("PPO")
                model_ensemble = model_ppo
            # Check if TD3 is the best model
            elif sharpe_td3 > sharpe_ddpg:
