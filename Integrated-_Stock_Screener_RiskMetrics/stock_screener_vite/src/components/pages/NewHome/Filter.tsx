...
import { FilterOption, FilterRange } from "../../../utils/defaults/companyQueryDefaults";

function Filter<T extends FilterOption<string | FilterRange>>(props: {
    displayName: string;
    filterName: string;
    options: T[];
    defaultSelected: T;
    onChange: (filterName: string, optionSelected: T) => void;
}) {
