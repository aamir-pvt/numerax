        ...
        <div className="flex items-center space-x-4">
          ...
          <form
            ...
            onSubmit={(e) => {
              ...
              navigate(`/cryptoList?search=${searchQuery}`, { replace: true });
            }}
          >
            <button type="submit">
        ...
        <div className="flex flex-col space-y-5 py-4">
          <div className="w-full space-y-2">
            ...
            <div className="w-full">
              ...
              {!loading ? filteredCryptoList.map((crypto, index) => (
                <div className="w-full crypto-row" key={index}>
                  <div className="grid grid-cols-6 px-3">
                    <h3 className="text-blue-900"> {/* Link to CompanyDetails page */}
                      <Link to={`/cryptoDetails?code=${crypto.ticker}`} >{crypto.ticker}</Link>
                    </h3>
                    <h3>{crypto.name}</h3>
                ...
                <div className="flex pt-20 pb-4 pl-[45%]">
